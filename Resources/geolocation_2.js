...
if (isIPhone3_2_Plus())
{
	...
	Ti.Geolocation.purpose = "GPS Location";
}
...
else
{
	...
	if (Titanium.Geolocation.hasCompass)
	{
		...
		var headingCallback = function(e)
		{
			...
			setTimeout(function()
			{
				updatedHeading.color = '#fff';
				updatedHeadingTime.color = '#fff';
	...
	var locationCallback = function(e)
	{
		...
		setTimeout(function()
		{
			updatedLatitude.color = '#fff';
			updatedLocation.color = '#fff';
			updatedLocationAccuracy.color = '#fff';
			updatedLocationTime.color = '#fff';
